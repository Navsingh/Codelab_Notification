...
class NotificationHelper extends ContextWrapper {
    ...
    public static final String FOLLOWERS_CHANNEL_ID = "follower";
    public static final String DIRECT_MESSAGES_ID = "direct_Messages";
    ...
    public NotificationHelper(Context context) {
        super(context);
        // Create the channel object with the unique ID FOLLOWERS_CHANNEL_ID
        NotificationChannel followersChannel = new NotificationChannel(FOLLOWERS_CHANNEL_ID, getString(R.string.notification_channel_followers),
        ...
        NotificationChannel directMessages = new NotificationChannel(DIRECT_MESSAGES_ID,"Direct Messages Channel",NotificationManager.IMPORTANCE_HIGH);
        directMessages.setLightColor(Color.BLUE);
        directMessages.setShowBadge(true);
        getNotificationManager().createNotificationChannel(directMessages);
    }
    ...
    public Notification.Builder getNotificationFollower(String title, String body) {
        return new Notification.Builder(getApplicationContext(), FOLLOWERS_CHANNEL_ID)
    ...
    public Notification.Builder getNotificationDM(String title, String body) {
        return new Notification.Builder(getApplicationContext(), DIRECT_MESSAGES_ID)
                .setContentTitle(title)
                .setContentText(body)
                .setSmallIcon(getSmallIcon())
                .setAutoCancel(true)
