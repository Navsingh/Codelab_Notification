...
public class MainActivity extends Activity {
    ...
    private void goToNotificationChannelSettings(String channel) {
        ...
        intent.putExtra(EXTRA_CHANNEL_ID,channel);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.follower_channel_settings_button:
                    goToNotificationChannelSettings(NotificationHelper.FOLLOWERS_CHANNEL_ID);
                    break;
                ...
                case R.id.dm_channel_settings_button:
                    goToNotificationChannelSettings(NotificationHelper.DIRECT_MESSAGES_ID);
                    break;
